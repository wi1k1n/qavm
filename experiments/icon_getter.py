...
PATHS = [
	...
	Path("c:\\Program Files\\AIMP\\AIMP.exe"),
]
...
if __name__ == "__main__":
	...
	parser.add_argument("-l", "--largest", action="store_true",  default=True,  # Flag, if present it is set to True, else False
