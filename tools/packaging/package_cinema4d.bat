...
python.exe gather-builtin-plugins.py --pluginsFolder ../../../plugins --destination build/qavm/builtin_plugins
...
pyinstaller.exe .\%APP_NAME%.spec --distpath ../../../dist --noconfirm
